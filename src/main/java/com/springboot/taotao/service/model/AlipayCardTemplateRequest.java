 ...
 */
@Accessors
public class AlipayCardTemplateRequest {
    ...
    /**
     * 卡类型为固定枚举类型(目前仅支持 OUT_MEMBER_CARD：外部权益卡)
     */
     ...
     */
    @JSONField(name = "biz_no_suffix_len")
     ...
     */
    @JSONField(name = "service_label_list")
    private String serviceLabelList;
    ...
    public String getServiceLabelList() {
        return serviceLabelList;
    }

    public void setServiceLabelList(String serviceLabelList) {
    ...
    public String toString() {
        return "AlipayCardTemplateRequest [request_id=" + requestId + ", template_id="
                + templateId + ", card_type=" + cardType + ", biz_no_prefix=" + bizNoPrefix
                + ", biz_no_suffix_len=" + bizNoSuffixLen + ", write_off_type=" + writeOffType
                ...
                + ", open_card_conf=" + openCardConf + ", service_label_list=" + serviceLabelList
